...
<template>
    ...
    <section class="bg-white dark:bg-gray-900">
        ...
        >
            <div class="flex flex-col justify-center">
                ...
                >
                    <a
                        href="https://github.com/Vinzzztty"
                    ...
                    <a
                        href="https://www.fiverr.com/kevinarnandes?up_rollout=true"
        ...
        >
            <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                >
                    ...
                    >
                        <a
                            href="https://www.linkedin.com/in/kevin-arnandes-a27b421b2/"
    ...
    <section class="bg-grey-50" id="project">
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <p class="text-gray-800 text-base px-6 mb-5">
                            Website you can ask and answer, like a Forum
                        </p>
                    </a>
                </div>
                <div
                ...
                >
                    <div class="flex items-center justify-start">
                        <button
                            class="mx-auto lg:mx-0 hover:underline gradient text-dark font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                        >
                            <a href="https://www.tanya-red.com/">See more</a>
                        </button>
                    </div>
                </div>
            </div>
